...
function renderCategory() {
  ...
  const title = category.title || 'CBSE';
  document.title = `${title} — Digital Library`;
  $('#categoryTitle').textContent = title;
  $('#categoryDescription').textContent = category.description || 'Interactive CBSE curriculum storybooks and concept learning.';
  $('#categoryBadge').textContent = category.badge || 'CURRICULUM';
}
